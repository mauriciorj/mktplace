...
const threeSteps = () => {
    ...
    return(
        ...
        <Row className="threeSteps">
            <Col span={24}>
            <Typography.Title level={2} className="threeSteps-title">3 simple steps</Typography.Title>
            </Col>
        </Row>
        <Row className="threeSteps-cards">
            ...
            <Card
                hoverable
                cover={<img alt="example" src={threeSteps1} />}
            >
            <Card.Meta 
            ...
            <Card
                hoverable
                cover={<img alt="example" src={threeSteps2} />}
            >
            <Card.Meta 
            ...
            <Card
                hoverable
                cover={<img alt="example" src={threeSteps3} />}
            >
            <Card.Meta 
