    ...
    return (
        <>
            <Row className="talkingAboutUs">
                <Col span={24}>
                    <Typography.Title level={2} className="threeSteps-title">What our users are talking about us</Typography.Title>
                </Col>
            </Row>
            <Row className="talkingAboutUs-cards">
                <Col offset={2} span={6}>
                    <Card
                        bordered={false}
                        cover={<img alt="example" src={threeSteps1} className="talkingAboutUs-card-image" />}
                    >
                        <Card.Meta
                            title="Flirck, Paul"
                ...
                <Col offset={1} span={6}>
                    <Card
                        bordered={false}
                        cover={<img alt="example" src={threeSteps2} className="talkingAboutUs-card-image" />}
                    >
                        <Card.Meta
                            title="Green, Ann"
                ...
                <Col offset={1} span={6}>
                    <Card
                        bordered={false}
                        cover={<img alt="example" src={threeSteps3} className="talkingAboutUs-card-image" />}
                    >
                        <Card.Meta
                            title="Bart, John"
